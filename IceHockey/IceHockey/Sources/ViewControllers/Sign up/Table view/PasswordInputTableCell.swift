...
class PasswordInputTableCell: UITableViewCell {
    ...
    func configureUI() {
        if let data = data {
            passwordTextField.configure(data: data)
...
extension PasswordInputTableCell: UITextFieldDelegate {
...
extension PasswordInputTableCell: ConfigurableCollectionContent {
