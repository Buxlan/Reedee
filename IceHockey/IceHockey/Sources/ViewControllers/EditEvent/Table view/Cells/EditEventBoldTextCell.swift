...
class EditEventBoldTextCell: UITableViewCell {
    ...
    private lazy var dataTextView: TextViewWithPlaceholder = {
        ...
        view.placeholder = L10n.EditEventLabel.boldTextPlaceholder
        return view
    }()
    ...
    internal func configureConstraints() {
        let constraints: [NSLayoutConstraint] = [
            ...
            dataTextView.heightAnchor.constraint(greaterThanOrEqualToConstant: 80),
...
extension EditEventBoldTextCell: ConfigurableCollectionContent {
...
extension EditEventBoldTextCell: UITextViewDelegate {
