//
//  TrainingScheduleNavigationController.swift
//  IceHockey
//
...
class TrainingScheduleNavigationController: UINavigationController {
    ...
    private func configureTabBarItem() {
        tabBarItem.title = L10n.TabBar.trainingSchedule
